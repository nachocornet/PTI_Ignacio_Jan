...
- [frontend.html](frontend.html): pantalla principal UX
- [frontend.variables.js](frontend.variables.js): variables del frontend
...
## 4. Flujo de frontend (frontend.html)

1. Carga config desde frontend.variables.js
2. Intenta cargar wallet desde walletSources
3. Muestra estado operativo (chips + tracker)
4. Emite VC y actualiza vista legible
5. Firma VP localmente con wallet holder
6. Verifica y muestra resultado en formato humano
...
- Se actualizo README
- Se incorporo [GUIA_FRONTEND.md](GUIA_FRONTEND.md)
